      ...
      <div className="w-full max-w-md relative z-10">
        <GlassCard hover={false} padding={true}>
          <div className="flex flex-col items-center gap-2 mb-8 text-center">
            ...
            <h2 className="font-display font-extrabold text-3xl text-gradient mt-2">Welcome Back</h2>
            <p className="text-slate-500 text-sm">Sign in to your LinkedIn Content Agent</p>
          </div>
